...
$analyse = array(/* TOUTES les analyses de tous les profils :cry: */
    ...
    array('ENTP', 'd\'inventeur', '3,20', 'https://fr.wikipedia.org/wiki/ENTP', 'Vous vous intéressez à des sujets très variés, il est donc difficile de vous mettre dans une case, vous aimez vous engager dans plusieurs causes/sujets/objectifs à la fois mais vous ne finissez pas toujours vos projets. Vous avez tendance à vous éparpiller et à être facilement distrait. A la fois rationnel et fantaisiste, vous avez de l’imagination analytique, ce qui aboutit à des idées originales mais il est difficile de le mettre en œuvre. Vous aimez débattre pour la richesse des argumentes et vous vous rangez souvent du côté de l’avocat du diable pour enrichir votre esprit innovateur.'),
