...
<html lang="fr">
    ...
    <body>
        <div class="background">
            <header>
                <nav class="nav-barre">
                    <a class="nav-barre-ele1" href="index.php"><i class="fas fa-home"></i> ACCUEIL</a>
                    <a class="nav-barre-ele2" href="test.php"><i class="fas fa-clipboard-list"></i> LE TEST</a>
                </nav>
            </header>
...
?>              <div class="question"> <?php
        ...
        echo '</br>';
        echo '<p>' . $reponses[$nbReponse][0] . ' OU ' . $reponses[$nbReponse][1] . '</p>';
?>
...
<?php
                ...
                echo '</br>';
                $lien = "<a target=\"_blank\" href=". $analyse[$index][2] . ">En savoir plus</a>";
                echo $lien;
?>
         </div>
<?php
    ...
    echo '<p>Cliquez ici pour recommencer le test </p>'; ?>
                <form action="test.php" method="post">
                    <input type="hidden" name="detruireSession" value="true"/>
                    <p><input type="submit" value="OK"></p>
                </form>
        </div>
<?php }else { /* Si on n'a pas encore posé de question */?>
            <div class="question">
<?php
    echo '<p>'.$questions[0].'</p>';
    echo '</br>';
    echo '<p>' . $reponses[0][0] . ' OU ' . $reponses[0][1] . '</p>'; ?>
